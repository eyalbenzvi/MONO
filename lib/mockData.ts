import { teeColorForTone, type ArtTone, type FeatureVector, type ShirtProduct } from "@/types/shirt";
...
const seeds: Seed[] = [
  {
    ...
    description: "Stacked concrete facade shot straight-on, pulled in white ink on a black tee.",
  ...
  },
  {
    ...
    description: "Dense newsprint columns — a wall of black text as texture on white.",
...
export const MOCK_SHIRTS: ShirtProduct[] = seeds.map((s, i) => ({
  ...
  price: s.price,
  artTone: s.artTone,
  baseColor: teeColorForTone(s.artTone),
  description: s.description,
  backImageUrl: unsplash(s.photo, 600, 800),
  features: s.features,
}));
