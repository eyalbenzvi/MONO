...
const TAILS: Record<ShirtCategory, string[]> = {
  ...
  wildlife: [
    "A real photograph, not a drawing: the dots hold the fur and feathers.",
    "Reads as a picture from across the room, as dots up close.",
    "Printed like a newspaper photo, one ink and a screen.",
    "Quiet animal portrait, loud enough to start a conversation.",
    "The zoo, printed the old-fashioned way.",
    ...
    "Soft tones made of hard dots.",
    "A field guide page you can wear.",
    "Honest photograph, simple print.",
    "Looks better the longer you look.",
  ],
  flight: [
    "A museum photograph, screened like an old airshow poster.",
    "Aviation history in one ink.",
    "For people who look up when something flies over.",
    "Reads as a photo from a distance, as pure pattern up close.",
    "Hangar light, printed in dots.",
    ...
    "Classic lines, halftone texture.",
    "Flight, frozen in one colour.",
  ],
  machines: [
    "Every rivet and dial, in one ink.",
    "Mechanical detail, photographed and screened.",
    ...
    "Dots doing the work of polished metal.",
